	...
	{#await sectionOnePromise then _}
		...
		<div class="profile-image" use:addSlickScrollOffset>
			{#await loadImage("assets/imgs/profile.jpg") then src}
				...
				}} alt="Ghanshyam's Profile" class="profile-pic">
			{/await}
		</div>
	{/await}
</div>
...
<div class="horizontal-flex" bind:this={section2Element}>
	{#await sectionTwoPromise then _}
		<ul class="list first">
			...
			<li>
				...
				<div class="flex-item" in:maskSlideIn={{ delay: 700 }}>
					...
					<img src="assets/imgs/svg-icons/dotnet.svg" alt="php">
					<img src="assets/imgs/svg-icons/python.svg" alt="php">
				</div>
			</li>
			<li>
				...
				<div class="flex-item" in:maskSlideIn={{ delay: 800 }}>
					<img src="assets/imgs/svg-icons/azure.svg" alt="Azure Devops">
			...
			<li>
				...
				<div class="flex-item" in:maskSlideIn={{ delay: 900 }}>
					<img src="assets/imgs/svg-icons/sql.svg" alt="flutter">
		...
		<ul class="list">
			...
			<li>
				<div in:letterSlideIn={{ initDelay: 550 }}>
					SDE-2 EM International, Bangalore, India
				</div>
			</li>
		</ul>
	{/await}
